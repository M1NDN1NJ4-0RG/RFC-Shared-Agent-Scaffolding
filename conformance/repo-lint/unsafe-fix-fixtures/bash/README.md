# Bash Unsafe Fix Fixtures

## Purpose

This directory contains **intentionally non-conforming** Bash scripts used for testing unsafe fix mode in `repo_lint`.
...
**TODO:** Unsafe fixers for Bash are not yet implemented.

When Bash unsafe fixers are added, this directory will contain fixtures that demonstrate:

- - Non-conforming docstring formats that can be auto-fixed unsafely - Edge cases that unsafe fixers must handle
  correctly
