...
- Bash: `RFC-Shared-Agent-Scaffolding-Example/scripts/bash/scripts/safe-run.sh:54-84`
- Perl: `RFC-Shared-Agent-Scaffolding-Example/scripts/perl/scripts/safe-run.pl:71-103`
- Python3: `RFC-Shared-Agent-Scaffolding-Example/scripts/python3/scripts/safe-run.py:58-89`
- PowerShell: `RFC-Shared-Agent-Scaffolding-Example/scripts/powershell/scripts/safe-run.ps1:63-102`
...
**Implementation Locations:**
- Bash: `RFC-Shared-Agent-Scaffolding-Example/scripts/bash/scripts/safe-run.sh:18-30`
- Perl: `RFC-Shared-Agent-Scaffolding-Example/scripts/perl/scripts/safe-run.pl:21-37`
- Python3: `RFC-Shared-Agent-Scaffolding-Example/scripts/python3/scripts/safe-run.py:21-32`
- PowerShell: `RFC-Shared-Agent-Scaffolding-Example/scripts/powershell/scripts/safe-run.ps1:23-44`
...
**Implementation Locations:**
- Bash: `RFC-Shared-Agent-Scaffolding-Example/scripts/bash/scripts/safe-run.sh:113` - uses `exec "$BINARY" run "$@"`
- Perl: `RFC-Shared-Agent-Scaffolding-Example/scripts/perl/scripts/safe-run.pl:140` - uses `exec($binary, 'run', @args)`
- Python3: `RFC-Shared-Agent-Scaffolding-Example/scripts/python3/scripts/safe-run.py:126` - uses `os.execvp(binary, [binary, "run"] + args)`
- PowerShell: `RFC-Shared-Agent-Scaffolding-Example/scripts/powershell/scripts/safe-run.ps1:140` - uses `& $binary run @invokeArgs`
...
**Implementation Locations:**
- Bash: `RFC-Shared-Agent-Scaffolding-Example/scripts/bash/scripts/safe-run.sh:113` - uses `exec` (replaces process, automatic)
- Perl: `RFC-Shared-Agent-Scaffolding-Example/scripts/perl/scripts/safe-run.pl:140` - uses `exec` (replaces process, automatic)
- Python3: `RFC-Shared-Agent-Scaffolding-Example/scripts/python3/scripts/safe-run.py:126` - uses `os.execvp` (replaces process, automatic)
- PowerShell: `RFC-Shared-Agent-Scaffolding-Example/scripts/powershell/scripts/safe-run.ps1:140-146` - uses `& $binary` then `exit $LASTEXITCODE`
...
**Implementation Locations:**
- Bash: `RFC-Shared-Agent-Scaffolding-Example/scripts/bash/scripts/safe-run.sh:87-108`
- Perl: `RFC-Shared-Agent-Scaffolding-Example/scripts/perl/scripts/safe-run.pl:108-129`
- Python3: `RFC-Shared-Agent-Scaffolding-Example/scripts/python3/scripts/safe-run.py:95-115`
- PowerShell: `RFC-Shared-Agent-Scaffolding-Example/scripts/powershell/scripts/safe-run.ps1:107-128`
...
**Implementation Locations:**
- Bash tests: `RFC-Shared-Agent-Scaffolding-Example/scripts/bash/tests/test-safe-run.sh:11-20`
- PowerShell tests: `RFC-Shared-Agent-Scaffolding-Example/scripts/powershell/tests/safe-run-tests.ps1:14-15`
...
**Implementation Locations:**
- Bash: `RFC-Shared-Agent-Scaffolding-Example/scripts/bash/scripts/safe-run.sh:32-49`
- Perl: `RFC-Shared-Agent-Scaffolding-Example/scripts/perl/scripts/safe-run.pl:42-66`
- Python3: `RFC-Shared-Agent-Scaffolding-Example/scripts/python3/scripts/safe-run.py:34-56`
- PowerShell: `RFC-Shared-Agent-Scaffolding-Example/scripts/powershell/scripts/safe-run.ps1:46-61`
