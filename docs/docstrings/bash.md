...
**File:** `RFC-Shared-Agent-Scaffolding-Example/scripts/bash/scripts/safe-run.sh`
...
**File:** `RFC-Shared-Agent-Scaffolding-Example/scripts/bash/tests/test-safe-run.sh`
...
**File:** `RFC-Shared-Agent-Scaffolding-Example/scripts/bash/scripts/safe-check.sh`
