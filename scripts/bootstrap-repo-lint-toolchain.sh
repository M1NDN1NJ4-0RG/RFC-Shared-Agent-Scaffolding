...
main() {
	...
	log "    export PERL_LOCAL_LIB_ROOT=\"\$HOME/perl5\${PERL_LOCAL_LIB_ROOT:+:\${PERL_LOCAL_LIB_ROOT}}\" && \\"
	log "    export PERL_MB_OPT=\"--install_base \"\$HOME/perl5\"\" && \\"
	log "    export PERL_MM_OPT=\"INSTALL_BASE=\$HOME/perl5\" && \\"
	log "    export PERL5LIB=\"\$HOME/perl5/lib/perl5\${PERL5LIB:+:\${PERL5LIB}}\" && \\"
	log "    export PATH=\"\$HOME/perl5/bin\${PATH:+:\${PATH}}\" && \\"
