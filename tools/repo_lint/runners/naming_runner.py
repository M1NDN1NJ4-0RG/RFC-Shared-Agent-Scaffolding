...
class NamingRunner(Runner):
    ...
    def fix(self, policy: dict = None, verbose: bool = False) -> List[LintResult]:
    ...
    def _check_file_naming(self, file_path: Path, repo_root: Path, verbose: bool = False) -> LintResult:
